...
The Riemannian Havelock identity states that the sum

    T_m = sum_{p=1}^{N-1} [1 - cos(2π p m/N)] / [2 sin²(π p/N)]

equals m(N-m) exactly for all integers 1 ≤ m ≤ N-1.

This identity is the key to computing the Thomson Lagrangian Hessian
eigenvalues analytically: the eigenvalue of the m-th Fourier block of the
Lagrangian Hessian is lambda_m = c - T_m / N, where c is a constant fixed
