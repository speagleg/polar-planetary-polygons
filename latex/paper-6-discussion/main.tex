...
$\delta_{\mathrm{CKM}} = \arctan(\sqrt{7}) = 69.3^\circ$ & Prediction & Derivation & $0.10\sigma$ \\
$\sin^2\theta_W = 3/11$ & Prediction & Derivation$^*$ & $0.1\%$ (2-loop) \\
$|V_{us}| = 0.230$ & Prediction & Derivation & $2\%$ \\
$|V_{cb}| = 0.043$ & Prediction & Derivation & $1\%$ \\
$|V_{ub}| = 0.0024$ (instanton) & Prediction & Derivation & $35\%$ \\
$\theta_{12}^{\mathrm{PMNS}} = 32.9^\circ$ & Prediction & Derivation & $0.5^\circ$ \\
$\theta_{23}^{\mathrm{PMNS}} = 45^\circ$ & Prediction & Derivation & $1\sigma$ \\
$\theta_{13}^{\mathrm{PMNS}} = 9.3^\circ$ & Prediction & Derivation & $0.8^\circ$ \\
$\eta_B = 5.96 \times 10^{-10}$ & Prediction & Derivation & $2.6\%$ \\
