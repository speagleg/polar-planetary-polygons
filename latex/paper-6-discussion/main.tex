...
\item \emph{Paper~IV (Gauge theory):}
  ...
  $\sin^2\theta_W = 3/11$; the CKM phase $\delta = 68.63^\circ$;
...
and CKM phase $\delta = 2\,\theta_{\mathrm{CS}}\tanh(\pi) = 68.63^\circ$.
...
$\delta_{\mathrm{CKM}} = 68.63^\circ$ & Prediction & Derivation & $0.12\sigma$ \\
...
elasticity $-0.3$).
The CKM phase $\delta_{\mathrm{CKM}} = 68.63^\circ$
