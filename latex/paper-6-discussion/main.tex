...
Six binary tests---normal neutrino hierarchy, $w = -1$,
no $0\nu\beta\beta$, proton stability,
$\theta_{\mathrm{QCD}} = 0$, and the EWPT gravitational
wave signal---are experimentally accessible within two decades.
