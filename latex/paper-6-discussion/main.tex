...
In a quasi-2D Bose--Einstein condensate, quantised
...
(circuit-QED or topoelectric realisations) reduce to the
...
(3)~quantised pulsar glitch sizes
...
potentially stabilising polar vortex polygons.
...
high-field objects but not yet confirmed---quantised
...
($\beta > 0$): the ground state is thermally favoured over
...
Independent of the high-energy programme, the mathematical
...
hyperbolic lattice realisations ($N_{\mathrm{crit}} = 12$
