...
The framework's accuracy should be compared not to the
...
The algebraic-tier predictions ($< 5\%$) include all
quantities that reviewers previously classified as
``geometric'' ($m_s/m_b$), once the $O(1/c)$ Euler class
