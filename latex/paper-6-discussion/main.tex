...
The $O(1/c)$ BO truncation error propagates as
${\sim}2\%$ per step (Paper~III, \S\ref*{III-sec:wdw});
the Euler class correction
(eq.~\eqref*{IV-eq:Dc-corrected}) accounts for
the leading fiber-connection effect at the same order.
