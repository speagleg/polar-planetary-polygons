...
The vortex-spacetime identification (c) --- that the Onsager
selection principle on the Regge polygon system selects the
physical spacetime geometry --- is the framework's starting
