...
Seven binary tests---normal neutrino hierarchy, $w = -1$,
no $0\nu\beta\beta$, proton stability,
$\theta_{\mathrm{QCD}} = 0$, the EWPT gravitational
wave signal, and $\Omega_k = 0$---are experimentally
accessible within two decades.
A single failure falsifies the theory.
