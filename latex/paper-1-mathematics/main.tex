...
and $\lambda_{\mathrm{bind}}(12,1) \approx 0.78$.
...
strictly ordered: Proposition~\ref{prop:monotonicity}),
...
$\mathrm{sign}(h)$ is a non-trivial projection
in~$C^*_r(\Gamma)$ with
$\tau(\mathrm{sign}(h)) = 2\tau(P_-(h)) - 1 \ne \pm 1$.
