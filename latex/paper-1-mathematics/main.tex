...
Paper~III for a detailed assessment).  The
...
\begin{enumerate}
  ...
  \item \textbf{Meso scale: polygon arrangement.}  Given $N$ vortex
    ...
    surface (the constrained energy minimum (Paper~II, Theorem~8.2)).  By the energy-Casimir
...
The meso-scale proof (the constrained energy minimum (Paper~II, Theorem~8.2)) applies to
...
(the constraint-intersection principle (Paper~III)).  Both mechanisms share the
...
(the wavenumber selection (Paper~III)).
