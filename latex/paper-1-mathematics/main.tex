...
The results of this section---the generalized Havelock formula,
the eigenvalue pairing theorem, and the icosahedral bridge identity---are
new and connect the polygon framework to the $E_8$ gauge theory
...
The Hessian~$H$ is $G$-equivariant.  On the isotypic component
of~$\rho$ (multiplicity~$2$ from
$\operatorname{Ind}(\omega) \oplus \operatorname{Ind}(\bar\omega)$),
Schur's lemma gives
