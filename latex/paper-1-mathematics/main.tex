...
by the identity $2(N{+}1)/(N{-}7) = 2 + 16/(N{-}7)$.
...
Each trace $B$ gives a primitive hyperbolic element: $B = 3, 4, 6, 10, 18$ are not Chebyshev values $T_k(B')$ for any $k \ge 2$, $B' \ge 3$ (since $T_2(3) = 17$, $T_2(4) = 31$, etc.).
\end{proof}
