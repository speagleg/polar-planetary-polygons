...
(tangential), with $h(d) = -(1/2\pi)\log d + \varphi(d)$.
...
\[
  ...
  = \frac{\log N - (N{-}1)\log 2}{N{-}1}
  = \frac{\log N}{N{-}1} - \log 2.
\]
Combining: $b(N) = N(N{+}1)/12 - \log 2 + (\log N)/(N{-}1)$.
...
cancels the $\log d$ divergence), so
