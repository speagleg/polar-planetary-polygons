...
The offset decomposes as $b(N) = \langle f_m\rangle + \langle S_m\rangle$,
...
($N_{\mathrm{crit}} \ge 7$), with the $N = 7$ marginal mode
becoming strictly stable at any nonzero ring radius
