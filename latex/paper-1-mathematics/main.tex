...
\begin{remark}[The $\csc^2$ kernel in other contexts]
The $\csc^2$ kernel underlying the Havelock identity appears in
the Calogero--Moser--Sutherland model, the Dyson circular ensemble,
the Haldane--Shastry spin chain, the Laughlin edge theory,
the Selberg integral, the $W_N$ algebra, and the AGT/Nekrasov
correspondence.  In each context, $B_2 = 1/6$ governs the
self-interaction correction ($\csc^2(x) = 1/x^2 + 2B_2 + O(x^2)$).
\end{remark}
