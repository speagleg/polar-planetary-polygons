...
\subsection{Vortex dynamics as a Langlands laboratory}
...
\subsection{Identification of the modular form}
...
\subsection{Complete characterisation of $a_p$}
...
\subsection{Modularity from the stability analysis}
...
\subsection{Twin primes and the stability fingerprint}
...
\subsection{Non-solvable palindromic polynomials and the Langlands programme}
