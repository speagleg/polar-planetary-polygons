...
\S\ref{S-sec:bolza-modular} and the palindromic growth
...
in Proposition~\ref{prop:higher-genus},
...
$B = C^*_r(\Gamma)$:
\begin{itemize}
\item \emph{$F_\xi$ is self-adjoint.}
...
Remark~\ref{S-rmk:bolza-physics}) because the
