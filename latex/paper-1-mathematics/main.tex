...
When does a regular polygon of point vortices constitute a stable
equilibrium, and how does the curvature of the ambient surface change
the answer?  This is the central mathematical question of the present
paper.  The physical motivation---polygonal storm patterns on Saturn
and Jupiter \citep{Godfrey1988, Adriani2018}---is developed in
Paper~III; the point vortex dynamics, constrained energy landscape,
and continuous-vorticity bridge are developed in Paper~II.
Paper~I is self-contained: it requires only the definitions of
point vortex energy and the Havelock eigenvalue, both recalled below.
