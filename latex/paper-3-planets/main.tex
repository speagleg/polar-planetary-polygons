...
Section~Paper~II, \S13 (the $K_0$ stability table).
...
(2)~the analytic sign rule (Theorem~the sign rule (Paper~I, Theorem~3.1));
...
(Theorem~Paper~II, Theorem~8.2), the sign rule
(Theorem~the sign rule (Paper~I, Theorem~3.1)), and the stability table---are proven
