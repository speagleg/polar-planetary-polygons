...
The baryon fraction has residual tension ($12\sigma$) that depends
on the precise value of the mass gap~$\Delta E$.
\end{proposition}
...
$\Delta E \approx 0.81$.
The remaining $12\sigma$ tension in $\Omega_b$ thus reduces to
a ${\sim}18\%$ uncertainty in the mass gap, which is within
the numerical precision of the WDW computation
(the FEM boundary condition contributes a systematic error
at this level for $c \approx 127$).
