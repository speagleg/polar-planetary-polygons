...
$\int S(R(x))\,dA$ subject to $\int R\,dA = 2\pi\chi$
...
\item[\textup{(H2)}]
  ...
  at the threshold $N = 7$; all remaining $\lambda_m > 0$),
...
$\|Y\|_{L^\infty} \le |V_1|\cdot 0.90 + \tfrac12|V_2|\cdot 0.81 \le 1.0$,
so $e^{2|\beta_{\mathrm{eff}}|\,\|Y\|_\infty} \le e^{1/3} = 1.40$.
