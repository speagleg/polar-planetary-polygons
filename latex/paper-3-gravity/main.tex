...
\item \emph{Analytic}: the log-symbol Fourier coefficients $c_k$
  ...
  The Szeg\H{o} constant (using the complex-DFT convention
  $c_k = a_k/2$ for $k \ge 1$, as in the standard
  formula $C_S = \exp(\sum_{k \ge 1} k|c_k|^2)$):
  $|c_1| = 0.173$, $|c_2| = 0.027$,
  $C_S = \exp(1 \times 0.030 + 2 \times 0.00075) = 1.032$,
  and $S/c_1^2 = 0.46$ (using the cosine convention).
