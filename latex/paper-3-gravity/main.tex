...
\emph{Derivation of\/ \textup{(H2)} from the vortex-gravity
isomorphism.}
One might object that the Onsager principle extremises
vortex \emph{configurations} at fixed background
