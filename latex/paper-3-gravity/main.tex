...
In particular, it applies to the Regge system regardless
of whether the Regge dynamics matches the Kirchhoff
vortex dynamics: only the phase-space structure
...
($\Gamma$-convergence of strictly concave functionals
under $H^1$ mesh refinement \citep{Aubin1998}).
