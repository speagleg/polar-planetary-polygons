...
the polygon entropy.
The global equilibration across the surface is provided by
the Green's function itself: $G(x,y)$ couples polygon systems
at different points~$x$ and~$y$, creating a connected
thermodynamic system whose entropy is maximised collectively.
