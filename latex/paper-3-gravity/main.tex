...
\paragraph{Main result and reading guide.}
The central theorem (Theorem~\ref{thm:polygon-einstein},
\S\ref{sec:lichnerowicz}) is:
the impatient reader may proceed directly to
\S\ref{sec:lichnerowicz}, referring back as needed.
The theorem states:
