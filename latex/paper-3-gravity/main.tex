...
\item \emph{Onsager contraction (constructive, finite~$N$).}
  ...
  proves $97\%$ variance reduction per iteration
  at $N = 7$, with explicit bounds.
...
genus~$g$ with $\lambda_1 > 1/4$ (the Selberg
conjecture, proved for arithmetic surfaces and
