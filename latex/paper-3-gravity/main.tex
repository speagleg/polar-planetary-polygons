...
see Code Availability\footnote{All numerical
...
the semiclassical expansion has $O(1/k^2) \approx 1.4\%$
corrections for $N \ge 7$ ($k > 8.6$).
...
(the boundary CFT is unitary and has a
unique vacuum---see Paper~IV,
