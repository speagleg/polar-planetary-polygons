...
\item \textbf{(H2) has two layers:}
  ...
  \item[\textbf{(H2b)}] \textbf{Onsager selection
    ...
    \textbf{This is the load-bearing physical hypothesis
    of the series}: extending the Onsager principle from
    vortex configurations on a \emph{given} surface
    to the metric itself (via the vortex-gravity isomorphism)
    is the framework's physical content.
