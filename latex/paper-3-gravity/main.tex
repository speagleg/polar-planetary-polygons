...
The Osgood--Phillips--Sarnak spectral determinant
theorem then selects the constant-curvature geometry
as the unique entropy maximum.
All conditions (H1)--(H3) are mathematical theorems;
the $17$~testable outputs enumerated in Paper~VII
constitute the empirical test of the identification.
