...
\end{equation}
  ...
  $\delta\rho/N^{-2/3} \to (24)^{-1/3} \approx 0.347$).
...
\begin{equation}\label{eq:einstein-from-polygon}
  R_{\mu\nu} = \Lambda\,g_{\mu\nu},
  \qquad
  \Lambda = \frac{3\bigl[f(m^*,N) - (N{-}1)\bigr]}
                 {(N{-}1)\,\varepsilon^2}.
\end{equation}
...
\begin{equation}\label{eq:C1-expansion-proof}
  C_1(x, \varepsilon)
  = (N{-}1)\!\left[1 + \frac{R(x)\,\varepsilon^2}{6}
    + O(\varepsilon^4)\right],
\end{equation}
where $R(x)$ is the scalar curvature at~$x$.
The coefficient $1/6$ arises from the Hadamard parametrix:
$G(x,y) = -(1/2\pi)[\log d - R\,d^2/12 + O(d^4)]$,
and the ring sum $\sum_{p=1}^{N-1}\cos(2\pi pm/N) = -1$
for the first Havelock mode extracts $R\varepsilon^2/6$
from the $d^2$ correction
(the $\varepsilon^2$ coefficient comes from the Hadamard
parametrix of the Green's function).
...
$R_0 = 6[f(m^*,N) - (N{-}1)]/[(N{-}1)\varepsilon^2]$.
