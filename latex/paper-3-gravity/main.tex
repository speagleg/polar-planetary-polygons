...
The value $c = 12\,b(N)$ is uniquely determined:
it is the only kinetic coefficient for which (i)~the
quantum BO factorization holds and (ii)~the Brown--Henneaux
central charge matches the CMS--CS Casimir identification.
Both constraints give the same~$c$, providing a cross-check.)
