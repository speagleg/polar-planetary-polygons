...
(details in \S\ref{sec:intro-gravity}).
The same $c = 12\,b(N)$ serves as WDW kinetic coefficient,
CS level ($k = c/6$), Brown--Henneaux central charge
($G := 3\ell/(2c)$), and orbifold CFT ground-state energy.
If any role required a different~$c$, the framework would
be falsified.
